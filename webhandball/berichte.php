...
$query = "SELECT `id`, title, introtext, `fulltext` FROM `hka983_content` WHERE created > '2017-08-01 00:00:00.000000' AND title LIKE '%".$site."%' ORDER BY id DESC ";// "Select * FROM comments";
